...
@XmlRootElement(name = "VWCARGAINICIALMVBENEFICIARIOSASSISTENCIAL")
@Table(name = "VW_CARGA_INICIAL_MV_BENEFICIARIOS_ASSISTENCIAL")
@Entity
public class BeneficiarioAssistencial implements Beneficiario{
	...
	public BeneficiarioAssistencial() {
		super();
	}
	@Override
