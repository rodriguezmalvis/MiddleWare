...
@XmlRootElement(name = "MvCacDeParaBeneficiarioAssistencial")
@Table(name = "MV_CAC_DE_PARA_BENEFICIARIO_ASSISTENCIAL")
@Entity
public class MvCacDeParaBeneficiarioAssistencial {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name="id_cac_de_para_beneficiario_assistencial")
	private int id;
	...
	public MvCacDeParaBeneficiarioAssistencial() {

	}

	public MvCacDeParaBeneficiarioAssistencial(int id, int id_pessoa, int cod_pessoa, Date timestamp) {
		super();
		this.id = id;
