...
@XmlRootElement(name = "VWCARGAINICIALMVBENEFICIARIOSASSISTENCIALTODOS")
@Table(name = "VW_CARGA_MV_BENEFICIARIOS_ASSISTENCIAL_TODOS")
@Entity
public class BeneficiarioAssistencialTodos implements Beneficiario{
	...
	public BeneficiarioAssistencialTodos() {
		super();
	}
	@Override
